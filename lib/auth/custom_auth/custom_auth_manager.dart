...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    pasargadrugsAuthUserSubject.add(
      PasargadrugsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PasargadrugsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PasargadrugsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PasargadrugsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    pasargadrugsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
PasargadrugsAuthUser? currentUser;
