...
class _ContactUsPageWidgetState extends State<ContactUsPageWidget>
  ...
  void initState() {
    ...
    _model.messageFTextController ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.messageFFocusNode ??= FocusNode();
  }
  ...
  @override
  void didUpdateWidget(ContactUsPageWidget oldWidget) {
  ...
  void didPush() {
    if (mounted && DebugFlutterFlowModelContext.maybeOf(context) == null) {
      ...
      UserJourneyTracker.trackScreenVisit(
        'ContactUs',
        screenClass: 'ContactUsPageWidget',
      );
    }
  }
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(),
                                child: Text(
                                  '1217 Connecticut Ave NW, Washington,\nDC 20036',
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: _model.nameFTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.messageFTextController,
                                  focusNode: _model.messageFFocusNode,
                                  autofocus: true,
                                  textInputAction: TextInputAction.next,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  maxLines: 8,
                                  validator: _model
                                      .messageFTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
