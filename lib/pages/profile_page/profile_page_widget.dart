...
class _ProfilePageWidgetState extends State<ProfilePageWidget> with RouteAware {
  ...
  void initState() {
    ...
    _model.lastNameFTextController ??=
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            validator: _model
                                                .lastNameFTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                        Container(
                                  ...
                                  if (_model.formValid!) {
                                    _model.apiResultro3 =
                                        await PasargadrugsGroup
                                            ...
                                            .call(
                                      firstName:
                                          _model.fNameFTextController.text,
                                      lastName:
                                          _model.lastNameFTextController.text,
                                      token: currentAuthenticationToken,
                                    );

                                    _shouldSetState = true;
                                    if ((_model.apiResultro3?.succeeded ??
                                        true)) {
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            PasargadrugsGroup.updateProfileCall
                                                .message(
                                              (_model.apiResultro3?.jsonBody ??
                                                  ''),
                                            )!,
                                            style: TextStyle(
                                              color:
