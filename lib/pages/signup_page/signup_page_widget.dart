...
class _SignupPageWidgetState extends State<SignupPageWidget> with RouteAware {
  ...
  void initState() {
    ...
    _model.fNameFTextController ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.fNameFFocusNode ??= FocusNode();

    _model.lastNameFTextController ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.lastNameFFocusNode ??= FocusNode();
    ...
    _model.passFTextController ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.passFFocusNode ??= FocusNode();

    _model.conPassFTextController ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.conPassFFocusNode ??= FocusNode();
  }
  ...
  @override
  void didUpdateWidget(SignupPageWidget oldWidget) {
                        ...
                        children: [
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model.fNameFTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model.lastNameFTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Container(
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model.passFTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model.conPassFTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ...
                        onPressed: () async {
                          ...
                          if (_model.formValid!) {
                            ...
                            _model.signupResult =
                              ...
                              lastName: _model.lastNameFTextController.text,
                              email: _model.emailFTextController.text,
                              password: _model.passFTextController.text,
                              passwordConfirmation:
                                  _model.conPassFTextController.text,
                            );
                            ...
                            if ((_model.signupResult?.succeeded ?? true)) {
                              FFAppState().user = UserStruct(
                                ...
                                firstName:
                                    PasargadrugsGroup.registerCall.firstname(
                                  (_model.signupResult?.jsonBody ?? ''),
                                ),
                                lastName:
                                    PasargadrugsGroup.registerCall.lastname(
                                  (_model.signupResult?.jsonBody ?? ''),
                                ),
                                email: PasargadrugsGroup.registerCall.email(
                                  (_model.signupResult?.jsonBody ?? ''),
                                ),
                                status:
                                    PasargadrugsGroup.registerCall.statusCode(
                                  (_model.signupResult?.jsonBody ?? ''),
                                ),
                                fullName:
                                    PasargadrugsGroup.registerCall.fullname(
                                  (_model.signupResult?.jsonBody ?? ''),
                                ),
                              );
                              FFAppState().token =
                                  PasargadrugsGroup.registerCall.token(
                                (_model.signupResult?.jsonBody ?? ''),
                              )!;
                              safeSetState(() {});
                              ...
                              await authManager.signIn(
                                ...
                                authUid: PasargadrugsGroup.registerCall
                                    .userID(
                                      (_model.signupResult?.jsonBody ?? ''),
                                    )
                                    ?.toString(),
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Please fill out correct information to continue.',
                                  style: TextStyle(
                                    color: FlutterFlowTheme.of(context)
                                        .primaryText,
                                  ),
                          ...
                          children: [
                            ...
                            TextSpan(
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () async {
                                  await launchURL(
                                      'https://pasargad.com/terms-conditions');
                                },
                            ),
                            TextSpan(
                              text: ' and ',
                            ...
                            TextSpan(
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () async {
                                  await launchURL(
                                      'https://pasargad.com/privacy-policy');
                                },
                            )
                          ],
                          style:
