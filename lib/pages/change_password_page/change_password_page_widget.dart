...
class _ChangePasswordPageWidgetState extends State<ChangePasswordPageWidget>
  ...
  void initState() {
    ...
    _model.oldPasswordFTextController ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.oldPasswordFFocusNode ??= FocusNode();

    _model.newPasswordFTextController ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.newPasswordFFocusNode ??= FocusNode();
  }
  ...
  @override
  void didUpdateWidget(ChangePasswordPageWidget oldWidget) {
  ...
  void didPush() {
    if (mounted && DebugFlutterFlowModelContext.maybeOf(context) == null) {
      ...
      UserJourneyTracker.trackScreenVisit(
        'ChangePassword',
        screenClass: 'ChangePasswordPageWidget',
      );
    }
  }
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .oldPasswordFTextController,
                                            focusNode:
                                                _model.oldPasswordFFocusNode,
                                            autofocus: true,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText:
                                                !_model.oldPasswordFVisibility,
                                            ...
                                            validator: _model
                                                .oldPasswordFTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                        Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .newPasswordFTextController,
                                            focusNode:
                                                _model.newPasswordFFocusNode,
                                            autofocus: true,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText:
                                                !_model.newPasswordFVisibility,
                                            decoration: InputDecoration(
                                              labelStyle: FlutterFlowTheme.of(
                                                      context)
                                                  .labelMedium
                                            ...
                                            validator: _model
                                                .newPasswordFTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
