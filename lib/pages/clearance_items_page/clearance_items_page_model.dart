...
import '/index.dart';
import 'clearance_items_page_widget.dart' show ClearanceItemsPageWidget;
...
class ClearanceItemsPageModel
    extends FlutterFlowModel<ClearanceItemsPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (products)] action in ClearanceItemsPage widget.
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        widgetClassName: 'ClearanceItemsPage',
      );
}
