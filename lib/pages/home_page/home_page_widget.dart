...
class _HomePageWidgetState extends State<HomePageWidget> with RouteAware {
  ...
  // Loading state UI shown while the home call resolves.
  ...
  // Hidden top bar used as a spacer/placeholder.
  Widget _buildHiddenStatusBar(BuildContext context) {
    return Container(
  ...
  // Top logo and profile/cart/fav quick actions.
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        context.pushNamed(FavProductsPageWidget.routeName);
                      },
                    ),
                  ),
                ],
      ...
      child: Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            contentPadding: EdgeInsetsDirectional.fromSTEB(15.0, 0.0, 15.0, 0.0),
            suffixIcon: Icon(
          ...
          validator: _model.searchFTextControllerValidator.asValidator(context),
        ),
      ),
    );
  }
  ...
  Widget _buildSliderSection(
    BuildContext context,
    ApiCallResponse homePageHomeResponse,
  ) {
    return Padding(
      ...
      child: Container(
        ...
        child: Builder(
          builder: (context) {
            final slider = PasargadrugsGroup.homeCall.slider(
  ...
  Widget _buildShopBySizeGrid(
    ...
    return Padding(
      ...
      child: Builder(
        builder: (context) {
          final shopBySize = PasargadrugsGroup.homeCall.shopBySize(
                homePageHomeResponse.jsonBody,
              )?.withoutNulls.toList() ??
              [];
          _model.debugGeneratorVariables[
  ...
  // Banner for quick navigation to sale items.
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Image.asset('assets/images/specia_offer.png',
                      width: 150, height: 75),
                ),
              ],
            ),
  ...
  // Banner for clearance navigation.
  Widget _buildClearanceBanner(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        ...
        onTap: () async {
          context.pushNamed(
            ClearanceItemsPageWidget.routeName,
            queryParameters: {
              'navTitle': serializeParam(
                'Clearance',
                ParamType.String,
  ...
  Widget _buildFeaturedProducts(
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Builder(
          builder: (context) {
            final product = PasargadrugsGroup.homeCall.products(
                  homePageHomeResponse.jsonBody,
                )?.toList() ??
                [];
            _model.debugGeneratorVariables[
  ...
  Widget _buildCategories(
    ...
    return Padding(
      padding: EdgeInsetsDirectional.fromSTEB(20.0, 10.0, 0.0, 30.0),
      child: Container(
        width: double.infinity,
        height: 100.0,
        decoration: BoxDecoration(),
        child: Builder(
          builder: (context) {
            final category = PasargadrugsGroup.homeCall.categories(
                  homePageHomeResponse.jsonBody,
                )?.toList() ??
                [];
            _model.debugGeneratorVariables[
                    ...
                    onTap: () async {
                      context.pushNamed(
                        ...
                        queryParameters: {
                          ...
                          'filter': serializeParam(
                            PasargadrugsGroup.homeCall.filters(
                              homePageHomeResponse.jsonBody,
                            ),
                            ParamType.JSON,
                          ),
  ...
  Widget _buildCollections(
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Builder(
          builder: (context) {
            final collection = PasargadrugsGroup.homeCall.collections(
                  homePageHomeResponse.jsonBody,
                )?.toList() ??
                [];
            _model.debugGeneratorVariables[
            ...
            return SingleChildScrollView(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.max,
                children: List.generate(collection.length, (collectionIndex) {
  ...
  // Scrollable body that holds all sections on the home page.
  Widget _buildMainScrollable(
    BuildContext context,
    ApiCallResponse homePageHomeResponse,
  ) {
    return Padding(
      ...
      child: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            mainAxisSize: MainAxisSize.max,
            children: [
              _buildSliderSection(context, homePageHomeResponse),
              _buildSectionTitle(
                context,
                'Shop By Size',
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 20.0, 20.0, 0.0),
              ),
              _buildShopBySizeGrid(context, homePageHomeResponse),
              _buildSaleBanner(context, homePageHomeResponse),
              _buildClearanceBanner(context),
              _buildSectionTitle(
                context,
                'Featured Items',
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 20.0, 20.0, 0.0),
              ),
              _buildFeaturedProducts(context, homePageHomeResponse),
              _buildSectionTitle(
                context,
                'Shop By Categories',
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 0.0),
              ),
              _buildCategories(context, homePageHomeResponse),
              _buildSectionTitle(
                context,
                'Collections',
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 0.0),
              ),
              _buildCollections(context, homePageHomeResponse),
            ],
          ),
        ),
      ),
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.max,
                children: [
                  _buildHiddenStatusBar(context),
                  _buildHeaderActions(context),
                  _buildSearchField(context),
                  Expanded(
                    child: _buildMainScrollable(context, homePageHomeResponse),
                  ),
                ],
              ),
            ),
